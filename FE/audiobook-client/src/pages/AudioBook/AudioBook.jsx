...
import { faLayerGroup, faUser, faMicrophoneLines, faHeadphones, faThumbTack } from '@fortawesome/free-solid-svg-icons'
            ...
            <div className="info-container">
                <div className="info-section">
                    ...
                    <div className="detail">
                        <div className="item">
                            <label><FontAwesomeIcon icon={faLayerGroup} /> Thể loại: </label>
                            <p>{getCategoryString(audioBook.categories)}</p>
                        </div>
                        <div className="item">
                            <label><FontAwesomeIcon icon={faUser} />Tác giả: </label>
                            <p>{audioBook.author}</p>
                        </div>
                        <div className="item">
                            <label> <FontAwesomeIcon icon={faMicrophoneLines} /> Giọng đọc: </label>
                            <p>{audioBook.voice}</p>
                        </div>
                        <div className="item">
                            <label> <FontAwesomeIcon icon={faHeadphones} /> Lượt nghe: </label>
                            <p>300</p>
                        </div>
                    </div>
                </div>
