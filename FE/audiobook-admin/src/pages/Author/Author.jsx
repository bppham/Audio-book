...
const Author = () => {
    ...
    const handleAddAuthor = async () =>{
        if(!authorName.trim()) {
            toast.warning("Author's name cannot be empty!");
            return;
        }
        try {
            const response = await addAuthor({name: authorName});
            setAuthors([...authors, response.data]); // update the author list
            setAuthorName("");
    ...
    const handleUpdate = async () =>{
        if(!newAuthorName.trim()){
            toast.error("Author's name cannot be empty");
            return;
        }
        try {
            ...
            console.error("Faild to update author " + error);
