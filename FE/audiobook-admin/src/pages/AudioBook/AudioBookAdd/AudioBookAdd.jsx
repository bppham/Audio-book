...
const AudioBookAdd = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append("audioBook", new Blob([JSON.stringify(formattedAudioBook)], { type: "application/json" })); // Đúng cách gửi JSON
    ...
    <div className='audiobook-add'>
        ...
        <div className="form-add-audiobook">
            ...
            <div className="row">
                <div className="item">
                    <label>Author</label>
                    <select name="author" value={audioBook.author || ""} onChange={handleAuthorChange}>
                ...
                <div className="item">
                    <label>Voice</label>
                    <select name="voice" value={audioBook.voice || ""} onChange={handleVoiceChange}>
