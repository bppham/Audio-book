...
import { getAudiobookById, updateAudiobook } from '../../../services/AudiobookService';
...
const AudioBookUpdate = () => {
    ...
    useEffect(() => {
        if (audioBook) {
            setSeletedAuthorId(audioBook.author.id);
            setSeletedVoiceId(audioBook.voice.id);
        }
    }, [audioBook]);
    ...
    const handleAuthorChange = (e) => {
        ...
        if (selectedId === "new") {
            ...
            setAudioBook({ ...audioBook, author: { id: authorId } }); // Gửi object có id
    ...
    const handleVoiceChange = (e) => {
        ...
        if (selectedId === "new") {
            ...
            setAudioBook({ ...audioBook, voice: { id: voiceId } }); // Gửi object có id
            console.log(audioBook);
        }
    };
    ...
    const handleUpdate = async () => {
        console.log(audioBook);
        try {
            await updateAudiobook(audioBook.id, audioBook, image, audioFiles);
    ...
    <div className='audiobook-update'>
        ...
        <div className="form-update-audiobook">
            <div className="row">
                ...
                <div className="item">
                    <label>Title</label>
                    <input type="text" name="title" value={audioBook.title} onChange={handleInputChange} />
                </div>
            </div>
            <div className="row">
                <div className="item">
                    <label>Author</label>
                    <select name="author" value={audioBook.author.id} onChange={handleAuthorChange}>
                ...
                <div className="item">
                    <label>Voice</label>
                    <select name="voice" value={audioBook.voice.id} onChange={handleVoiceChange}>
            ...
            <div className="row">
                <div className="item">
                    ...
                    <input type="file" name="audioFiles" multiple accept="audio/*" onChange={handleAudioFiles} />
                </div>
                <div className="item">
                            ...
                            <ul>
                                ...
                                <li key={index}>
                                    <div className='action'>
                                        <button onClick={() => removeFile(index)} style={{ marginLeft: "10px", cursor: "pointer", color: "red" }}>
            ...
            <div className="row">
                <div className="item">
                    ...
                    <textarea name="description" value={audioBook.description} onChange={handleInputChange}></textarea>
                </div>
            </div>
            <div className="row">
                <div className="item">
                    <label>Note</label>
                    <textarea name="note" value={audioBook.note} onChange={handleInputChange}></textarea>
