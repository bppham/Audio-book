    ...
    <div className='audiobook-detail'>
        ...
        <div className="form-detail-audiobook">
            ...
            <div className="row">
                <div className="item">
                    <label>Author</label>
                    <input type="text" name="author" value={audioBook.author.name} readOnly />
                </div>
                <div className="item">
                    <label>Voice</label>
                    <input type="text" name="voice" value={audioBook.voice.name} readOnly />
                </div>
            </div>
            <div className="row">
                <div className="item">
                ...
                <div className="item">
                    ...
                    <input type="text" value={getCategoryString(audioBook.categories)} readOnly />
                </div>
            ...
            <div className="row">
                <div className="item">
                    ...
                    <textarea name="description" value={audioBook.description} readOnly></textarea>
                </div>
            </div>
            <div className="row">
                <div className="item">
