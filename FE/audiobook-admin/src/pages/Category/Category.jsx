...
const Category = () => {
    ...
    const handleAdd = async () =>{
        if(!categoryName.trim()) {
            toast.warning("Category's name cannot be empty!");
            return;
        }
        try {
            const response = await addCategory({name: categoryName});
            setCategories([...categories, response.data]); // update the category list
            setCategoryName("");
    ...
    const handleUpdate = async () =>{
        if(!newCategoryName.trim()){
            toast.error("Category's name cannot be empty");
            return;
        }
        try {
            ...
            console.error("Faild to update category " + error);
